    ...
    return (
        <section className="bg-white py-16">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4  px-10 items-stretch">
                ...
                <div className="bg-[#8093F129] rounded-2xl shadow-lg p-8 flex flex-col items-start md:items-center min-h-[260px]">
                    <h3 className="text-lg font-semibold text-gray-900 text-left md:text-center mb-5">
                        Compreensão Avançada
                    </h3>
                    <ul className="text-gray-800 list-inside space-y-4 text-sm text-left md:text-center">
